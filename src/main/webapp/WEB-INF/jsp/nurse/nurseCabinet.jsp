...
<head>
    <title>${resources.Nurse_personal_cabinet}</title>
    <meta charset="UTF-8"/>
...
<center>
    ...
    <c:choose>
        <c:when test="${patientsForTreatingByProcedureOrDrug.size()!=0}">
            ...
            <table border="1">
                ...
                <c:forEach var="record" items="${patientsForTreatingByProcedureOrDrug}">
                    <tr>
                        <td>
                            <%=counter++%>
                        </td>
                        ...
                        <td>
                            <form action="./controller" method="GET">
                                <input type="hidden" name="command" value="execute-treatment-by-nurse">
